export const translations = {
  en: {
    ...
    scrollForStatistics: "Scroll down for detailed statistics",
    gameOverview: "Game Overview",
    roundsPlayed: "Rounds Played",
    totalPoints: "Total Points",
    avgPerRound: "Avg Per Round",
    highestScore: "Highest Score",
    lowestScore: "Lowest Score",
    mostCompetitive: "Most Competitive",
    notableAchievements: "Notable Achievements",
    highestSingleScore: "Highest Single Score",
    fastestProgression: "Fastest Progression",
    mostPerfectRounds: "Most Perfect Rounds",
  ...
  de: {
    ...
    scrollForStatistics: "Nach unten scrollen für detaillierte Statistiken",
    gameOverview: "Spielübersicht",
    roundsPlayed: "Gespielte Runden",
    totalPoints: "Gesamtpunkte",
    avgPerRound: "Durchschnitt pro Runde",
    highestScore: "Höchster Punktestand",
    lowestScore: "Niedrigster Punktestand",
    mostCompetitive: "Umkämpfteste",
    notableAchievements: "Bemerkenswerte Leistungen",
    highestSingleScore: "Höchster Einzelpunktestand",
    fastestProgression: "Schnellster Fortschritt",
    mostPerfectRounds: "Meiste perfekte Runden",
    mostConsistent: "Konsistentester",
    playerStatistics: "Spielerstatistiken",
    currentPhase: "Aktuelle Phase",
    phasesCompleted: "Abgeschlossene Phasen",
    highestRound: "Höchste Runde",
    average: "Durchschnitt",
    perfectRounds: "Perfekte Runden",
    rounds: "Runden",
    avgPoints: "Durchschnittspunkte",
  },
  ...
  it: {
    ...
    // Statistics
    detailedStatistics: "Statistiche Dettagliate",
    gameStatistics: "Statistiche di Gioco",
    scrollForStatistics: "Scorri verso il basso per statistiche dettagliate",
    gameOverview: "Panoramica Gioco",
    roundsPlayed: "Round Giocati",
    totalPoints: "Punti Totali",
    avgPerRound: "Media per Round",
    highestScore: "Punteggio Più Alto",
    lowestScore: "Punteggio Più Basso",
    mostCompetitive: "Più Competitiva",
    notableAchievements: "Risultati Notevoli",
    highestSingleScore: "Punteggio Singolo Più Alto",
    fastestProgression: "Progressione Più Veloce",
    mostPerfectRounds: "Più Round Perfetti",
    mostConsistent: "Più Coerente",
    playerStatistics: "Statistiche Giocatori",
    currentPhase: "Fase Attuale",
    phasesCompleted: "Fasi Completate",
    highestRound: "Round Più Alto",
    average: "Media",
    perfectRounds: "Round Perfetti",
    rounds: "Round",
    avgPoints: "Punti Media",
  },
  ...
  fr: {
    ...
    scrollForStatistics: "Faites défiler vers le bas pour des statistiques détaillées",
    gameOverview: "Aperçu du Jeu",
    roundsPlayed: "Manches Jouées",
    totalPoints: "Points Totaux",
    avgPerRound: "Moyenne par Manche",
    highestScore: "Score le Plus Élevé",
    lowestScore: "Score le Plus Bas",
    mostCompetitive: "Plus Compétitive",
    notableAchievements: "Réalisations Notables",
    highestSingleScore: "Score Unique le Plus Élevé",
    fastestProgression: "Progression la Plus Rapide",
    mostPerfectRounds: "Plus de Manches Parfaites",
    mostConsistent: "Plus Cohérent",
    playerStatistics: "Statistiques des Joueurs",
    currentPhase: "Phase Actuelle",
    phasesCompleted: "Phases Complétées",
    highestRound: "Manche la Plus Élevée",
    average: "Moyenne",
  ...
  es: {
    ...
    scrollForStatistics: "Desplázate hacia abajo para estadísticas detalladas",
    gameOverview: "Resumen del Juego",
    roundsPlayed: "Rondas Jugadas",
    totalPoints: "Puntos Totales",
    avgPerRound: "Promedio por Ronda",
    highestScore: "Puntuación Más Alta",
    lowestScore: "Puntuación Más Baja",
    mostCompetitive: "Más Competitiva",
    notableAchievements: "Logros Destacados",
    highestSingleScore: "Puntuación Individual Más Alta",
    fastestProgression: "Progresión Más Rápida",
    mostPerfectRounds: "Más Rondas Perfectas",
